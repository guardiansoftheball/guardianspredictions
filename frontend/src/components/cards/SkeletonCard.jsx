  ...
  <Shell>
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2.5">
        <div
          className={`${shimmer} w-9 h-9 rounded-full bg-white/10 shrink-0`}
        />
...
export const QuestionCardSkeleton = () => (
  <Shell>
    <div className="flex items-start gap-3">
      <div
        className={`${shimmer} w-[46px] h-[34px] sm:w-[52px] sm:h-[38px] rounded bg-white/10 shrink-0`}
      />
      ...
      <div
        className={`${shimmer} w-10 h-10 rounded-full bg-white/10 shrink-0`}
      />
    </div>
    <div className="flex gap-2">
      <Pill className="flex-1" />
...
export const PredictionCardSkeleton = () => (
  <Shell>
    <div className="flex items-start gap-4">
      <div
        className={`${shimmer} w-[42px] h-[30px] sm:w-[46px] sm:h-[34px] rounded bg-white/10 shrink-0`}
      />
      <div className="flex-1 flex flex-col gap-2 min-w-0">
        <Bar className="w-full h-[16px]" />
